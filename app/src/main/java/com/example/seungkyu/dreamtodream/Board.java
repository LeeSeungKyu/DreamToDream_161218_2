    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                ...
                intent.putExtra("writer",item.getName());
    ...
    private class CreateBoardList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                for(int i=0; i<jsonArray.length(); i++){
                    ...
                    boardVOs.add(new BoardVO(jobj.getString("mb_title"), jobj.getString("m_name"), jobj.getString("mb_writeDate")));
                }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for(int i=0; i<boardVOs.size(); i++){
                adapter.addItem(boardVOs.get(i).getTitle(), boardVOs.get(i).getName(), boardVOs.get(i).getDate().substring(0,10));
            }
